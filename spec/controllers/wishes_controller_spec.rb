  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved wish as @wish" do
        ...
        post :create, {:wish => { "name" => "invalid value" }}, valid_session
        assigns(:wish).should be_a_new(Wish)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested wish" do
        ...
        Wish.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => wish.to_param, :wish => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the wish as @wish" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Wish.any_instance.stub(:save).and_return(false)
        put :update, {:id => wish.to_param, :wish => { "name" => "invalid value" }}, valid_session
        assigns(:wish).should eq(wish)
      end
