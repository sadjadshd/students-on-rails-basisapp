  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved wishlist as @wishlist" do
        ...
        post :create, {:wishlist => { "name" => "invalid value" }}, valid_session
        assigns(:wishlist).should be_a_new(Wishlist)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested wishlist" do
        ...
        Wishlist.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => wishlist.to_param, :wishlist => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the wishlist as @wishlist" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Wishlist.any_instance.stub(:save).and_return(false)
        put :update, {:id => wishlist.to_param, :wishlist => { "name" => "invalid value" }}, valid_session
        assigns(:wishlist).should eq(wishlist)
      end
